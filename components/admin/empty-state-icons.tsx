...
export function FolderIcon({ size = 24, className }: IconProps) {
  return (
    <svg
      ...
      style={{ color: "#94a3b8" }}
    >
      <path d="M22 19a2 2 0 0 1-2.414-.646l-6.359-7.905A2 2 0 0 0 9.682 10H7a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h5l2 3h9a2 2 0 0 1 2 2v10a2 2 0 0 1-.414 1.323l-.293.293" />
      <path d="M2 5a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2V7a2 2 0 0 0-2-2H2z" />
    </svg>
  );
}
