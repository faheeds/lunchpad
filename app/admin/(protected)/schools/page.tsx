      ...
      <div className="rounded-[14px] border border-slate-100 bg-white overflow-hidden divide-y divide-slate-50">
        ...
        {schools.length === 0 && (
          <div className="px-4 py-10 text-center">
            ...
            <p className="text-[13px] font-medium text-slate-400">No schools yet.</p>
            <p className="text-[11px] text-slate-300 mt-1">Add your first school below.</p>
          </div>
        )}
      </div>
      ...
      <details className="rounded-[14px] border border-slate-100 bg-white overflow-hidden">
        ...
        <form action={createSchool} className="px-4 pb-4 border-t border-slate-50 pt-3 space-y-3">
          <div className="grid grid-cols-2 gap-3">
            <div>
              <label className="text-[11px] text-slate-500 font-semibold block mb-1">School name</label>
              <input type="text" name="name" required placeholder="Lincoln Elementary"
