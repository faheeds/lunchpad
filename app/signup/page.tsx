...
const PLANS = [
  {
    ...
    price: "$49",
    period: "/mo",
    description: "Perfect for a couple of locations getting started.",
    features: ["Up to 2 schools or offices", "750 orders / month", "Email notifications", "14-day free trial"],
    highlight: false,
  },
  {
    id: "GROWTH",
    ...
    features: ["Up to 5 schools or offices", "2,000 orders / month", "Priority support", "14-day free trial"],
    highlight: true,
  },
  {
    id: "SCALE",
    ...
    features: ["Up to 10 locations", "Unlimited orders", "Dedicated onboarding", "14-day free trial"],
    highlight: false,
  },
];
